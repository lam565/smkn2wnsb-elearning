  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        ?>
        <a href="?module=ujian&mp=all" class="btn <?php echo $_GET['mp']=='all' ? "btn-default" : "btn-primary"; ?> btn-sm">Semua</a>
        <?php
        ...
        while ($rmp=mysqli_fetch_array($qmapel)){
          ...
          echo "<a href='?module=ujian&mp=$rmp[kd_mapel]' class='btn $cbtn btn-sm'>$rmp[nama_mapel]</a>  ";
        }
        ?>
